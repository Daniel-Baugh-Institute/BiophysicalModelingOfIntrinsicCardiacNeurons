...
I.	Figure 3
  1.	Clone GitHub repository and checkout to tag-v2.0.1
git clone https://github.com/suny-downstate-medical-center/ragp.git
  2.	Run Tdata_plots.py, which reads the data from tdata_all_15.csv

II.	Figure 4
  1.	Download scAnalysis.py and data files 22aug25b_allData.json and 22aug25d_allData.json
  2.	To produce Figure 5 A and B, uncomment lines 447-451
  3.	To produce Figure 5D, uncomment line 455
  4.	To produce Figure 5C, uncomment lines 459-461
  5.	Note that a large amount of RAM is required to run this file and Figure 5C may need to be produced separately from Figure 5 A, B, D

III.	Figure 5
  1.	Download classification.json and classification_firing_sequence.py
  2.	Run classification_firing_sequence.py to produce Figure 5A-E
  3.	Note that a large amount of RAM is required to run this file 
