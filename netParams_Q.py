...
genemod = {
    "ch_Hcn3_cp11": {"gHCN3bar": 0.008},
    "ch_Hcn1_cp9": {"gHCN1bar": 0.007},
    "ch_Cacna1g_cp41": {"gCav3_1bar": 0.0001},
    "ch_Cacna1a_cp5": {"gCav2_1bar": 0.00007},
    "ch_Cacna1d_md150284": {"pcaLbar": 0.0001},
    "ch_Hcn4_cp12": {"gHCN4bar": 0.0008},
    "ch_Cacna1c_cp3": {"gLbar": 0.002},
    "ch_Cacna1i_md279": {"gcabar": 0.002},
    "ch_Kcna1ab1_md80769": {"gbar": 0.025},
    "ch_Kcnj3_md2488": {"gbar": 0.0043},
    "ch_Cacna1b_cp6": {"gCav2_2bar": 0.001},
    "ch_Hcn2_cp10": {"gHCN2bar": 0.06},  # 0.0011
    "ch_Kcnc1_rothman": {"gbar": 0.025, "phi": cfg.phi},
    "ch_Scn1a_cp35": {"gNabar": 0.085},
}  # 0.0015
...
if cfg.stim == "IClamp":
    ...
    netParams.stimSourceParams["vclamp"] = {
        "type": "VClamp",
        "dur": [100, 400, 500],
        "amp": [cfg.hParams["v_init"], cfg.vc, cfg.hParams["v_init"]],
    }
    netParams.stimTargetParams["vclamp->CEL"] = {
        "source": "vclamp",
        "conds": {"cellType": "CEL"},
        "sec": "soma",
        "loc": 0.5,
