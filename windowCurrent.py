...
axs[1, 0].plot(
    volt, pkc, label="KCNC1 (slow activation)", marker="+", markersize=4, color="blue"
)
...
axs[1, 1].plot(
    volt, hc1b, label="Cacna1b (inactivation)", linestyle="dashed", color="green"
)
axs[1, 1].plot(volt, mc1c, label="Cacna1c (activation)", color="blue")
axs[1, 1].plot(
    volt, hc1c, label="Cacna1c (inactivation)", linestyle="dashed", color="blue"
)
axs[1, 1].plot(volt, mc1d, label="Cacna1d (activation)", color="magenta")
axs[1, 1].plot(
    volt, hc1d, label="Cacna1d (inactivation)", linestyle="dashed", color="magenta"
)
axs[1, 1].plot(volt, mc1g, label="Cacna1g (activation)", color="cyan")
axs[1, 1].plot(
    volt, hc1g, label="Cacna1g (inactivation)", linestyle="dashed", color="cyan"
)
axs[1, 1].plot(volt, mc1i, label="Cacna1i (activation)", color="red")
axs[1, 1].plot(
    volt, hc1i, label="Cacna1i (inactivation)", linestyle="dashed", color="red"
)
axs[1, 1].axvline(x=-61, color="k", label="RMP = -61 mV")
