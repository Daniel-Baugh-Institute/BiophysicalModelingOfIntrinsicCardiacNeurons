...
axs[1,0].plot(volt,nkc, label = 'KCNA1 (fast activation)', color='blue')
axs[1,0].plot(volt,pkc, label = 'KCNA1 (slow activation)', marker='+',markersize=4,color='blue')
axs[1,0].plot(volt,nkj, label = 'KCNA1 (activation)', color='green')
