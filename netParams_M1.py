...
genemod = {'ch_Cacna1a_cp5':{'gCav2_1bar': 0.00001},  'ch_Cacna1b_cp6':{'gCav2_2bar': 0.0001},
           ...
           'ch_Cacna1g_cp41':{'gCav3_1bar': 0.00001},  'ch_Cacna1i_md279':{'gcabar': 0.00027},
            ...
            'ch_Kcna1ab1_md80769':{'gbar': 0.011},  'ch_Kcnc1_rothman':{'gbar': 0.011, 'phi':0.85},  #0.0011          
            'ch_Kcnj3_md2488':{'gbar': 0.0015},                 'ch_Scn1a_md264834':{'gNav11bar': 0.1}}     #0.0015
...
if cfg.stim == 'IClamp':
    netParams.stimSourceParams['iclamp'] = {'type': 'IClamp', 'amp': 0.6, 'dur': 500, 'delay': 100} 
