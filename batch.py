...
def batch():
        ...
        params['cellnum'] = [100] #[x for x in range(101)]
        params['hcn1'] = [0.00001, -1] #[0.00001, 0.0001, 0.001, 0.01] 
        params['hcn2'] = [0.009] #[0.00009, 0.0009, 0.009, 0.09]
        params['hcn3'] = [0.0001, np.inf] #[0.00001, 0.0001, 0.001, 0.01]
