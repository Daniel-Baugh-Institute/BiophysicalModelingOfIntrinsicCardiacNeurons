...
def batch():
        ...
        params['ca1a'] = [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1]
        params['ca1b'] = [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1]
        params['ca1c'] = [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1]
