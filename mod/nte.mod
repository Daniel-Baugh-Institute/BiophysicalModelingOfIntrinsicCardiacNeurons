...
static double tetrospks2(double* X1d,double* X2d,double* XO,int szX1,int szXO,int shuf), pdfpr(), tetrospks3(double* X1d,double* X2d,double* X3d,double* XO,int szX1,int szXO,int shuf);
static int dbxi[10];
...
static double entropxfgxp (void* vv) {
  ...
  unsigned int sz,minv,maxv,cnt,i,j,szp,*X;
